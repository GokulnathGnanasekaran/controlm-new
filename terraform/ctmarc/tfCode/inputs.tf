...
variable "ctmem_primary_dns" {
  description = "CTMEM Primary dns"
  type        = string
}

variable "ctmem_failover_dns" {
  description = "CTMEM Failover dns"
  type        = string
}
...
locals {
  ...
  ctmem_primary_dns         = var.ctmem_primary_dns
  ctmem_failover_dns        = var.ctmem_failover_dns
}
